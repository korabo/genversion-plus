...
exports.generate = function (targetPath, opts, callback) {
  ...
  if (typeof opts.template !== 'string') {
    opts.template = './template.txt' // default
  }
  ...
  if (typeof author !== 'string') {
    err = new Error('Invalid version in package.json: ' + author)
    return callback(err)
  }
...
function replaceVars(line, varMap) {
